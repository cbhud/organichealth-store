    ...
    <main>
        <div class="container">
            <div class="admin-nav" style="margin-top: 30px;">
                ...
                <a href="create_category.php" class="active">Dodaj kategoriju</a>
            </div>
            <div class="create-product-form" style="max-width:340px;margin:36px auto 28px auto;">
                ...
                <input type="text" id="cat-name" maxlength="64"
                    style="width:100%;padding:9px 12px; border:1px solid #d1d5db; border-radius:6px; margin-bottom:12px;">
                <button id="cat-create-btn"
                    style="width:100%;padding:11px 0; background:#197b30; color:#fff; border:none; border-radius:8px; font-size:1.05em; font-weight:600; cursor:pointer;">Kreiraj
                    kategoriju</button>
            </div>
        </div>
    </main>
    ...
    <script>
        ...
        function validateCategoryName(name) {
            if (name.length < 2 || name.length > 64) {
                showMsg('Naziv mora imati bar 2 i najviše 64 slova.', false);
                return false;
            }
            return true;
        }
        ...
        $('#cat-create-btn').on('click', function (e) {
            ...
            $.ajax({
                ...
                success: function (resp) {
                    if (resp.trim() === 'OK') {
                        showMsg('Uspjesno ste napravili kategoriju!', true);

...
if (isset($_POST['ajax'])) {
    ...
    $inRecommended = (isset($_POST['inRecommended']) && $_POST['inRecommended'] === '1') ? 1 : 0;
    ...
    if (isset($_FILES['image_url']) && $_FILES['image_url']['error'] === UPLOAD_ERR_OK) {
        ...
        if ($fileSize > 5 * 1024 * 1024) {
            echo "Slika ne sme biti veća od 5MB.";
            exit;
        }
        $allowedType = ['image/jpeg', 'image/png', 'image/gif', 'image/webp'];
        if (!in_array($fileType, $allowedType)) {
            echo "Dozvoljeni formati su JPG, PNG, GIF i WEBP.";
            exit;
        }

        $newFileName = uniqid() . '-' . basename($fileName);
        $destPath = '../slike/' . $newFileName;
        $dbPath = 'slike/' . $newFileName;
    ...
    $stmt = $konekcija->prepare("INSERT INTO product (name, price, stock, description, img_url, category_id, inRecommended) VALUES (?, ?, ?, ?, ?, ?, ?)");
    $stmt->bind_param('sdissii', $name, $price, $stock, $description, $image_url, $category_id, $inRecommended);
...
<body>
    <header>
        <div class="container header-content">
            <a class="logo" href="../index.php"><img src="../slike/logo.jpg" alt="Logo"></a>
            <nav class="main-nav">
                <ul>
    ...
    <main>
        <div class="container">
            <div class="admin-nav" style="margin-top: 30px;">
                ...
                <a href="revenue.php">Prihodi i izvještaji</a>
                <a href="create_product.php" class="active">Dodaj proizvod</a>
            ...
            <div class="create-product-form">
                ...
                <form id="create-product">
                    ...
                    <label for="image_url">Slika proizvoda</label>
                    <div class="custom-file-upload">
                        <label for="image_url" class="custom-file-label">
                            <i class="fas fa-cloud-upload-alt"></i> <span id="file-name">Izaberi sliku...</span>
                        </label>
                        <input type="file" class="image_url" name="image_url" id="image_url" accept="image/*">
                    </div>

                    <label style="display: flex; align-items: center; gap: 8px; margin-bottom: 16px;">
                        <input type="checkbox" name="inRecommended" id="inRecommended" style="width: auto; margin: 0;">
                        <span>Prikaži na početnoj <small>(Izdvajamo iz ponude)</small></span>
                    </label>
        ...
        <div class="container footer-content">
            ...
            <div class="footer-right">
                ...
                <span class="footer-social">
                    <a href="https://www.instagram.com/organichealthcg" target="_blank" aria-label="Instagram"><i
                            class="fab fa-instagram"></i></a>
                    <a href="https://www.facebook.com/p/Organic-Health-CG-61553907063139/" target="_blank"
